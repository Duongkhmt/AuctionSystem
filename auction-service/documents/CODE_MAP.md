# CODE MAP — DỰ ÁN AUCTION SYSTEM (BACKEND MICROSERVICES)
## 1. System Overview

- **Framework / Platform:** `✅ Confirmed` Java 21, Spring Boot 3.2.3, Spring Cloud 2023.0.0 (`spring-boot-starter-web`, `spring-boot-starter-data-jpa`, `spring-boot-starter-security`, `spring-boot-starter-validation`, `spring-boot-starter-data-redis`, `redisson-spring-boot-starter`, `spring-cloud-starter-netflix-eureka-client`).
- **Loại hình kiến trúc:** `✅ Confirmed` Microservices Architecture (`eureka-server` Port 8761, `auction-service` Port 8080, `payment-service` Port 8082), Layered Architecture (Controller → Service → Repository → Database).
- **Entry Point:** `✅ Confirmed` [AuctionSystemApplication.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/AuctionSystemApplication.java) (có kích hoạt `@EnableScheduling`).
...
- **Chống Spam & Giới hạn Tốc độ (Rate Limiting):** `✅ Confirmed` [RateLimitAspect.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/aspect/RateLimitAspect.java) sử dụng Redis Lua Script chạy nguyên tử với `@Order(Ordered.HIGHEST_PRECEDENCE)` bảo vệ API đặt giá.
...
- **Thư viện bổ trợ (Tools/Mappers):** `✅ Confirmed` MapStruct 1.6.2 (sinh code ánh xạ DTO ↔ Entity), Lombok 1.18.34, `dotenv-java` 3.0.0 (tự động đọc `.env`), Redisson 3.35.0 (Distributed Lock).
- **Bảo mật & Ủy quyền (Single Entry Point Architecture):** `✅ Confirmed` Frontend kết nối DUY NHẤT qua Port 8080 (`auction-service`). Phân quyền RBAC 3-tier routes tại `auction-service` ([SecurityConfig.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/config/SecurityConfig.java)). Phía `auction-service` sử dụng [WalletProxyController.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/WalletProxyController.java) để nhận request ví từ Frontend và ủy quyền gọi `payment-service` via [PaymentFeignClient.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/client/PaymentFeignClient.java). Phía `payment-service` áp dụng Bảo mật Nội bộ 100% qua Header `X-Internal-Service-Key` ([InternalServiceSecurityFilter.java](file:///home/duong/Projects/Backend/payment-service/src/main/java/com/duong/auction/payment/security/InternalServiceSecurityFilter.java)), không dùng JWT/CORS thừa.
- **Tự động hóa ngầm (Scheduler):** `✅ Confirmed` Robot [AuctionScheduler.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/AuctionScheduler.java) chạy ngầm định kỳ 10 giây/lần tự động chuyển trạng thái phiên (với `@Transactional` repository update), retry thanh toán 50 đơn/lần, hủy đơn bùng tiền quá 48h kèm phạt gậy vi phạm.
...
|:-----------------|:---------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------|
| `controller`     | Tiếp nhận và điều hướng HTTP Request, gọi Service và trả về `ResponseEntity`.                | [AdminProductController](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/AdminProductController.java), [AuctionBiddingController](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/AuctionBiddingController.java), [BidderController](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/BidderController.java), [SellerProductController](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/SellerProductController.java), [ProductController](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/ProductController.java), [CategoryController](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/CategoryController.java)                                                               | Phụ thuộc vào `service`, `dto`. Không package nào phụ thuộc lại `controller`.                                          |
| `service`        | Thực thi logic nghiệp vụ kinh doanh, quản lý Transaction và điều phối dữ liệu.               | [ProductService](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/ProductService.java), [BiddingService](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/BiddingService.java), [OrderService](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/OrderService.java), [CloudinaryService](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/CloudinaryService.java), [AuctionScheduler](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/AuctionScheduler.java), [CategoryService](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/CategoryService.java)                                                                                                                                                 | Được gọi bởi `controller`. Phụ thuộc vào `repository`, `mapper`, `validator`, `helper`, `exception`, `entity`, `dto`.  |
| `service.helper` | Đóng gói các thuật toán tính toán phức tạp (Proxy Bidding, Bước giá, Batch Query chống N+1). | [ProxyBiddingEngineHelper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/ProxyBiddingEngineHelper.java), [ProductResponseHelper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/ProductResponseHelper.java), [BidStepCalculatorHelper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/BidStepCalculatorHelper.java), [OrderResponseHelper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/OrderResponseHelper.java), [ProductAuctionLookupHelper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/ProductAuctionLookupHelper.java), [BidResponseHelper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/BidResponseHelper.java)                   | Được sử dụng chuyên biệt bởi `service`.                                                                                |
| `validator`      | Đảm bảo dữ liệu thỏa mãn điều kiện kinh doanh trước khi thay đổi trạng thái hệ thống.        | [AuctionValidator](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/AuctionValidator.java), [BidValidator](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/BidValidator.java), [OrderValidator](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/OrderValidator.java), [ProductImageValidator](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/ProductImageValidator.java)                                                                                                                                                                                                                                                                                                                                                                                                                         | Được gọi bởi `service`. Ném `ApplicationException` nếu vi phạm quy tắc.                                                |
| `mapper`         | Chuyển đổi dữ liệu giữa DTO và JPA Entity.                                                   | [ProductMapper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/mapper/ProductMapper.java), [AuctionMapper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/mapper/AuctionMapper.java), [BidMapper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/mapper/BidMapper.java), [OrderMapper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/mapper/OrderMapper.java), [ProductImageMapper](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/mapper/ProductImageMapper.java)                                                                                                                                                                                                                                                                                                                     | Được gọi bởi `service` và `helper`.                                                                                    |
| `repository`     | Tương tác trực tiếp với Database PostgreSQL qua Spring Data JPA & Custom JPQL Queries.       | [ProductRepository](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/ProductRepository.java), [AuctionRepository](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/AuctionRepository.java), [BidRepository](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/BidRepository.java), [OrderRepository](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/OrderRepository.java), [PaymentRepository](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/PaymentRepository.java), [UserRepository](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/UserRepository.java)                                                                                                                     | Được phụ thuộc bởi `service`, `helper`, `validator`.                                                                   |
| `entity`         | Mô hình hóa các bảng cơ sở dữ liệu thành Java Object (ORM JPA).                              | [User](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/User.java), [Product](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Product.java), [Auction](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Auction.java), [Bid](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Bid.java), [Order](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Order.java), [Payment](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Payment.java), [Category](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Category.java), [ProductImage](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/ProductImage.java) | Được sử dụng xuyên suốt ở tất cả các tầng ngoại trừ Controller.                                                        |
...
| `exception`      | Quản lý lỗi tập trung và trả về JSON chuẩn theo ErrorCode.                                   | [GlobalExceptionHandler](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/exception/GlobalExceptionHandler.java), [ApplicationException](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/exception/ApplicationException.java), [ErrorCode](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/exception/ErrorCode.java), [ErrorResponse](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/exception/ErrorResponse.java)                                                                                                                                                                                                                                                                                                                                                                                                                       | Sử dụng ở toàn bộ ứng dụng khi ném exception.                                                                          |
| `config`         | Cấu hình Bean hệ thống (Security, CORS, Cloudinary SDK).                                     | [SecurityConfig](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/config/SecurityConfig.java), [CloudinaryConfig](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/config/CloudinaryConfig.java)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Tự động load bởi Spring Container khi khởi chạy app.                                                                   |
...
- **Cấu hình hiện tại:** `✅ Confirmed` Trong [SecurityConfig.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/config/SecurityConfig.java):
  - Session Stateless (`SessionCreationPolicy.STATELESS`).
  - CORS enabled, CSRF disabled.
  - Phân quyền RBAC 3 Tầng: `/v1/auth/**` (Public `permitAll()`), `/v1/bidders/**` & `/v1/sellers/**` (`hasRole('USER')`), `/v1/admin/**` (`hasRole('ADMIN')`).
- **Xác thực / Phân quyền:** `✅ Confirmed` Tích hợp `JwtAuthenticationFilter` giải mã Bearer Token HMAC-SHA256, nạp `UserCustomDetails` vào `SecurityContextHolder`. `OrderValidator` kiểm tra chống IDOR chính chủ ở tầng nghiệp vụ. Dịch vụ `payment-service` tích hợp Lớp 1 Feign `X-Internal-Service-Key` và Lớp 2 User JWT `/v1/wallets/me` (0ms SQL lookup via `userId` claim).
...
1. Đọc DTO: [ProductRequestDTO.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/dto/request/ProductRequestDTO.java)
2. Đọc Validator: [ProductImageValidator.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/ProductImageValidator.java) -> [AuctionValidator.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/AuctionValidator.java)
3. Đọc Cloudinary Service: [CloudinaryService.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/CloudinaryService.java)
4. Đọc Service chính: [ProductService.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/ProductService.java)
5. Đọc Helper chống N+1: [ProductResponseHelper.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/ProductResponseHelper.java)
6. Đọc Controllers: [SellerProductController.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/SellerProductController.java) -> [AdminProductController.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/AdminProductController.java)

### 📖 Muốn hiểu nghiệp vụ Đấu Giá Tự Động & Mua Ngay (Bidding Domain)
1. Đọc DTO: [BidRequestDTO.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/dto/request/BidRequestDTO.java)
2. Đọc Validator: [BidValidator.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/BidValidator.java)
3. Đọc tính bước giá: [BidStepCalculatorHelper.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/BidStepCalculatorHelper.java)
4. Đọc thuật toán Proxy Bidding: [ProxyBiddingEngineHelper.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/helper/ProxyBiddingEngineHelper.java)
5. Đọc Service chính: [BiddingService.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/BiddingService.java)
6. Đọc Controller: [AuctionBiddingController.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/AuctionBiddingController.java)

### 📖 Muốn hiểu nghiệp vụ Đơn Hàng & Thanh Toán (Order & Payment Domain)
1. Đọc Entities: [Order.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Order.java) -> [Payment.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/entity/Payment.java)
2. Đọc DTO: [CheckoutRequestDTO.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/dto/request/CheckoutRequestDTO.java) -> [ShipOrderRequestDTO.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/dto/request/ShipOrderRequestDTO.java)
3. Đọc Validator: [OrderValidator.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/validator/OrderValidator.java)
4. Đọc Service chính: [OrderService.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/OrderService.java)
5. Đọc Controller: [BidderController.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/controller/BidderController.java)

### 📖 Muốn hiểu Robot Chạy Ngầm & Phạt Bùng Đơn (Background Scheduler Domain)
1. Đọc cấu hình Scheduler: [AuctionSystemApplication.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/AuctionSystemApplication.java)
2. Đọc Robot xử lý: [AuctionScheduler.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/service/AuctionScheduler.java)
3. Đọc Custom Repository Bulk Queries: [AuctionRepository.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/AuctionRepository.java) -> [OrderRepository.java](file:///home/duong/Projects/Backend/auction-service/src/main/java/com/duong/auction/system/repository/OrderRepository.java)
